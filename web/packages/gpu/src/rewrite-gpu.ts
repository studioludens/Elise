...
import { encodeTokens, TOKEN_STRIDE } from "./tokens-gpu.js";
import { EXPAND_COUNT_WGSL } from "./shaders/expand-count.wgsl.js";
import { EXPAND_WRITE_WGSL } from "./shaders/expand-write.wgsl.js";
import { SCAN_WGSL } from "./shaders/scan.wgsl.js";
...
export async function rewriteOnGpu(
  ...
  const finalBytes = new Uint8Array(resultStaging.getMappedRange().slice(0, finalCount * TOKEN_STRIDE));
  resultStaging.unmap();
