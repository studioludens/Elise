...
import StatsHud from '../src/components/StatsHud/StatsHud';
...
describe('StatsHud', () => {
    test('renders counts and timings', () => {
        render(<StatsHud events={EVENTS} systemLength={42} rewriteMs={1.5} interpretMs={0.25} />);
    ...
    test('formats sub-millisecond times in microseconds', () => {
        render(<StatsHud events={[]} systemLength={0} rewriteMs={0.012} interpretMs={0.034} />);
