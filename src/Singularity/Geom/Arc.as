/**
* Arc.as - Simple pie-shaped wedge drawing class using a quad. Bezier as a primitive.
*
...
*/
    public function Arc(_r:Number, _xC:Number, _yC:Number, _start:Number, _end:Number)
    {
      __radius = _r > 0 ? _r : 10;
      __xC     = _xC;
      __yC     = _yC;
...
*
*/
    public function draw( _g:Graphics, _lineThick:Number, _lineColor:Number ):void
    {
      if( _g == null || __delta == 0 )
        return;
      ...
      //g.clear();
      _g.lineStyle(_lineThick,_lineColor);
